  ...
  return (
    <div className="flex min-h-dvh flex-col bg-surface safe-top safe-bottom">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        <div className="rounded-[var(--radius-lg)] bg-white shadow-sm">
          <div className="border-b border-border px-5 py-4">
            <h3 className="text-sm font-semibold text-muted uppercase tracking-wide">Settings</h3>
          </div>
          <div className="divide-y divide-border">
            <button
              onClick={async () => {
        ...
        <div className="rounded-[var(--radius-lg)] bg-white shadow-sm">
          <div className="border-b border-border px-5 py-4">
            <h3 className="text-sm font-semibold text-muted uppercase tracking-wide">Legal Information</h3>
          </div>
          <div className="divide-y divide-border">
        ...
        {/* App Version */}
        <p className="pb-4 text-center text-xs text-muted">PadPal v1.0.0</p>
      </div>
